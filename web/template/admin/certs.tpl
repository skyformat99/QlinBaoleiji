...
<ul>
	...
	<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_config&action=certs">证书配置</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
