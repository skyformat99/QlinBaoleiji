...
cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d %H:%M:%S");
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					...
					<td><a href="admin.php?controller=admin_apppub&addr={{$allsession[t].addr}}&backupdb_id={{$backupdb_id}}">{{$allsession[t].addr}}</a></td>
						...
						{{if $allsession[t].autologinflag eq 3 or $allsession[t].autologinflag eq 35}}| <img src="{{$template_root}}/images/ie_ico.png" width="16" height="16" align="absmiddle"> <a href="admin.php?controller=admin_apppub&action=view&sid={{$allsession[t]['sid']}}">URL查看</a>
						{{elseif $allsession[t].autologinflag eq 36}}
						...
						{{elseif $allsession[t].autologinflag eq 20}}
