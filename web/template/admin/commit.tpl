        ...
        <TR>
          ...
          <form name="f1" method=post enctype="multipart/form-data" action="admin.php?controller=admin_pro&action=docommit" target="hide">
            ...
            cellpadding="5" valign="top">
              <TBODY>
              <TR>
                <TD align="center"><TEXTAREA name="prelogincommit" id="prelogincommit" rows="5" cols="50" value=""></TEXTAREA>                  				   </TD></TR>
              <TR>
                <TD align="center"><INPUT class="an_02" type="submit" onclick="return submitcommit();" value="登录"></TD></TR></TBODY></TABLE>
