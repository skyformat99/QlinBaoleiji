     ...
     {{assign var="trnumber" value=$trnumber+1}}
		...
		<TD width="33%" align=right>IPv6优先: </TD>
          ...
          <tr {{if $trnumber % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
            ...
            <td><input type="text" class="wbk" name="sshport" class="input_shorttext" value="{{$sshport}}"></td>
          </tr>
          {{assign var="trnumber" value=$trnumber+1}}
          <tr {{if $trnumber % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
            <td align=right>RDP端口：</td>
            <td><input type="text" class="wbk" name="rdpport" class="input_shorttext" value="{{$rdpport}}"></td>
          </tr>
				  <TR >
<tr>
