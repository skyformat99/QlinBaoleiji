...
<input type="text" name="username" id="username"  onblur="changeusername(this.value,'u');" {{if $nametype eq 'realname'}}disabled='disabled'{{/if}}  style="width: {{if !$logintype.ldapauth and !$logintype.radiusauth and !$logintype.adauth and !$logintype.fingersecauth and !$logintype.localfingersecauth or !$loginauthtype or !$loginauthtype}}145{{else}}100{{/if}}px;{{if !$dpwdtime}}height:24px;{{/if}}{{if $nametype eq 'realname'}}display:none{{/if}}">
<input type="text" name="username" id="realname"  onblur="changeusername(this.value,'r');" {{if $nametype eq 'username' or !$nametype}}disabled='disabled'{{/if}}  style="width: {{if !$logintype.ldapauth and !$logintype.radiusauth and !$logintype.adauth and !$logintype.fingersecauth and !$logintype.localfingersecauth or !$loginauthtype or !$loginauthtype}}145{{else}}100{{/if}}px;{{if !$dpwdtime}}height:24px;{{/if}}{{if $nametype eq 'username'}}display:none{{/if}}">

{{else}}
<select name='username' id="username"  style="width: {{if !$logintype.ldapauth and !$logintype.radiusauth and !$logintype.adauth and !$logintype.fingersecauth and !$logintype.localfingersecauth or !$loginauthtype or !$loginauthtype}}145{{else}}100{{/if}}px;{{if !$dpwdtime}}height:24px;{{/if}}">
...
<select name='username' id="realname" disabled style="width: {{if !$logintype.ldapauth and !$logintype.radiusauth and !$logintype.adauth and !$logintype.fingersecauth and !$logintype.localfingersecauth or !$loginauthtype or !$loginauthtype}}145{{else}}100{{/if}}px;{{if !$dpwdtime}}height:24px;{{/if}}display:none">
...
{{/if}}
{{if $loginauthtype}}
{{if !$logintype.ldapauth and !$logintype.radiusauth and !$logintype.adauth and !$logintype.fingersecauth and !$logintype.localfingersecauth}}
