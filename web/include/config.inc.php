...
$_CONFIG['CONFIGFILE']['NGINX'] = '/opt/freesvr/nginx/conf/nginx.conf';
$attributes = array();
...
////sms config
$_CONFIG['SMS_ID'] = 3;//0 miaodiyun,1 
 ...
 * SERIAL:扩展码
 */
$_CONFIG['SMS'][3]['ECNAME']='阿拉善盟中心医院';
$_CONFIG['SMS'][3]['USERNAME']='freesvr';
$_CONFIG['SMS'][3]['USERPASSWD']='freesvr';
$_CONFIG['SMS'][3]['SIGN']='QxOn0hZT';
$_CONFIG['SMS'][3]['SERIAL']='';
$_CONFIG['ACCEPT_FILE'] = '/opt/freesvr/audit/etc/accept.txt';
$_CONFIG['WEBSERVER']=1;//0 apache,1 nginx
$_CONFIG['URLPROTOCOL']=1;//0 freesvr,1 baoleiji
$_CONFIG['License']=1;//0 or 1
?>
