<?php /* Smarty version 3.1.27, created on 2017-05-23 17:27:58
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/template/admin/x11session_list.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:13817295155924009e8ca0e2_96083020%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '094a4246fcb604c7436e32d4706e09610030f553' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/template/admin/x11session_list.tpl',
      1 => 1483623676,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13817295155924009e8ca0e2_96083020',
  'variables' => 
  array (
    'template_root' => 0,
    'backupdb_id' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5924009e9fed87_84780974',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5924009e9fed87_84780974')) {
function content_5924009e9fed87_84780974 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '13817295155924009e8ca0e2_96083020';
?>
...
function searchit(){
	var url = "admin.php?controller=admin_x11&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
";
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_x11&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
...
/images/an33.jpg" align="absmiddle"/></li> 
  ...
  <tr>
         <td >
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="main_content"><form action="admin.php?controller=admin_x11&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
...
>
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					<tr>
						<th class="list_bg"   width="9%"><a href="admin.php?controller=admin_x11&orderby1=cli_addr&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
">来源地址</a></th>
						<th class="list_bg"   width="9%"><a href="admin.php?controller=admin_x11&orderby1=addr&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
">设备地址</a></th>
						
						<th class="list_bg"   width="6%"><a href="admin.php?controller=admin_x11&orderby1=luser&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
">运维</a></th>
						<th class="list_bg"   width="6%"><a href="admin.php?controller=admin_x11&orderby1=realname&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
">真实姓名</a></th>
						<th class="list_bg"   width="7%"><a href="admin.php?controller=admin_x11&orderby1=user&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
">本地</a></th>
						<th class="list_bg"   width="11%"><a href="admin.php?controller=admin_x11&orderby1=start&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
">开始时间</a></th>
						<th class="list_bg"   width="11%"><a href="admin.php?controller=admin_x11&orderby1=end&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
">结束时间</a></th>
						<th class="list_bg"   width="5%"><a href="admin.php?controller=admin_x11&orderby1=filesize&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
">文件(K)</a></th>
...
?>
					<tr <?php if ($_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['dangerous'] > 1) {?>bgcolor="red"<?php } elseif ($_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['dangerous'] > 0) {?>bgcolor="yellow" <?php } elseif ($_smarty_tpl->getVariable('smarty')->value['section']['t']['index']%2 == 0) {?>bgcolor="f7f7f7"<?php }?> onmouseover="changeStyle(this,'o');" onmouseout="changeStyle(this,'<?php if ($_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['dangerous'] > 1) {?>red<?php } elseif ($_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['dangerous'] > 0) {?>yellow<?php } elseif ($_smarty_tpl->getVariable('smarty')->value['section']['t']['index']%2 == 0) {?>f7f7f7<?php }?>');">
										...
										<td><a href="admin.php?controller=admin_x11&srcaddr=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['cli_addr'];?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['cli_addr'];?>
</a></td>
					
					<td><a href="admin.php?controller=admin_x11&addr=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['addr'];?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['addr'];?>
</a></td>
					
					<td><a href="admin.php?controller=admin_x11&luser=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['luser'];?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['luser'];?>
</a></td>
					<td><a href="admin.php?controller=admin_x11&realname=<?php echo urlencode($_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['realname']);?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['realname'];?>
</a></td>
					<td><a href="admin.php?controller=admin_x11&user=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['user'];?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
...
&activex=1&sid=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['sid'];?>
&action=rdpmouse" >鼠标</a><?php } else { ?><img src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/file.gif" width="16" height="16" align="absmiddle"> <a href="#" onclick='window.open("admin.php?controller=admin_x11&action=download&sid=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['sid'];?>
...
&action=logindesc&type=x11&sessionid=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['sid'];?>
...
/images/scico.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_x11&action=del_session&sid=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['sid'];?>
">删除</a><?php }?></td>
					</tr>
					<?php endfor; endif; ?>
					<tr>
