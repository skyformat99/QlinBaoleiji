<?php /* Smarty version 3.1.27, created on 2017-08-15 12:55:21
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/template/admin/license.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:148216241959927eb9bd8598_36672571%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '148216241959927eb9bd8598_36672571',
  'variables' => 
  array (
    'language' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_59927eb9c925e4_90561931',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_59927eb9c925e4_90561931')) {
function content_59927eb9c925e4_90561931 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '148216241959927eb9bd8598_36672571';
?>
...
/images/an3.jpg" align="absmiddle"/></li>
  ...
  <tr>
	...
	<?php if ($_smarty_tpl->tpl_vars['_config']->value['License'] == 0) {?>
					<tr>
...
" ><?php echo $_smarty_tpl->tpl_vars['language']->value['devicenumber'];?>
						...
						<?php if ($_smarty_tpl->tpl_vars['licensekeytype']->value) {?>
						<th class="list_bg"  bgcolor="d9ecfa" width="6%"><a href="admin.php?controller=admin_index&action=license&orderby1=equipnum&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >动态口令</a></th>
						<th class="list_bg"  bgcolor="d9ecfa" width="6%"><a href="admin.php?controller=admin_index&action=license&orderby1=equipnum&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >VPN</a></th>
						<?php }?>
						<th class="list_bg"  bgcolor="d9ecfa" width="6%"><a href="admin.php?controller=admin_index&action=license&orderby1=ssh&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >字符协议</a></th>
						<th class="list_bg"  bgcolor="d9ecfa" width="6%"><a href="admin.php?controller=admin_index&action=license&orderby1=rdp&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >图形协议</a></th>
						<th class="list_bg"  bgcolor="d9ecfa" width="6%"><a href="admin.php?controller=admin_index&action=license&orderby1=apppub&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >应用发布</a></th>
...
<?php if ($_smarty_tpl->tpl_vars['licensekeytype']->value) {?>
<td><?php if ($_smarty_tpl->tpl_vars['license']->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']]['priority'][0]) {?>打开<?php } else { ?>关闭<?php }?></td>
<td><?php if ($_smarty_tpl->tpl_vars['license']->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']]['priority'][3]) {?>打开<?php } else { ?>关闭<?php }?></td>
<?php }?>
<td><?php if ($_smarty_tpl->tpl_vars['license']->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']]['ssh']) {?>打开<?php } else { ?>关闭<?php }?></td>
<td><?php if ($_smarty_tpl->tpl_vars['license']->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']]['rdp']) {?>打开<?php } else { ?>关闭<?php }?></td>
<td><?php if ($_smarty_tpl->tpl_vars['license']->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']]['apppub']) {?>打开<?php } else { ?>关闭<?php }?></td>
...
<td><?php if ($_smarty_tpl->tpl_vars['license']->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']]['protocol']) {?>打开<?php } else { ?>关闭<?php }?></td>
<td><?php if ($_smarty_tpl->tpl_vars['license']->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']]['sftp']) {?>打开<?php } else { ?>关闭<?php }?></td>
<td><?php if ($_smarty_tpl->tpl_vars['license']->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']]['clipboard']) {?>打开<?php } else { ?>关闭<?php }?></td>
<td><?php if ($_smarty_tpl->tpl_vars['license']->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']]['disk']) {?>打开<?php } else { ?>关闭<?php }?></td>
</tr>
<?php endfor; endif; ?>
<?php }?>
