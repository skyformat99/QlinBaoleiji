<?php /* Smarty version 3.1.27, created on 2017-06-07 01:22:50
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/template/admin/resource_group_index.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:13059077675936e4ea684794_33672396%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0f9d68045ab2249386992f281613ecc2916c2d12' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/template/admin/resource_group_index.tpl',
      1 => 1496769767,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13059077675936e4ea684794_33672396',
  'variables' => 
  array (
    'title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5936e4ea77d962_68758217',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5936e4ea77d962_68758217')) {
function content_5936e4ea77d962_68758217 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '13059077675936e4ea684794_33672396';
?>
...
function searchit(){
	...
	var obj1=document.getElementById('agroupiddh');	
	gid=obj1.value;
	<?php } else { ?>
	for(var i=1; true; i++){		
	...
	<td class="" colspan = "4"><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="main_content">
                ...
                <TBODY>
				 <TR>
					...
					&nbsp;&nbsp;组名:<input type="text" class="wbk" name="groupname" value="" />&nbsp;&nbsp;用户:<input type="text" class="wbk" name="username" value="" />&nbsp;&nbsp;
