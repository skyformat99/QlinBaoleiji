<?php /* Smarty version 3.1.27, created on 2017-08-22 10:35:59
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/template/admin/appserver_list.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:550598554599b988f68e065_24927080%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1f4fe608d8c33aacc0590b4b08377a7beda80637' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/template/admin/appserver_list.tpl',
      1 => 1503369352,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '550598554599b988f68e065_24927080',
  'variables' => 
  array (
    'template_root' => 0,
    'orderby2' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_599b988f70d981_95357489',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_599b988f70d981_95357489')) {
function content_599b988f70d981_95357489 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '550598554599b988f68e065_24927080';
?>
...
function loadurl(url,width){
	...
	$.get(url, {Action:"get",Name:"lulu","1":Math.round(new Date().getTime()/1000)}, function (data, textStatus){
		...
		closeWindow()
		if(data.substring(0,'window.parent.location'.length)=='window.parent.location'){
			eval(data);
		}else{
			alert(data);
		}
...
" >应用发布服务器IP</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_config&action=appserver_list&orderby1=outsideip&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >外网NAT IP</a></th>
...
" >描述</a></th>
				<th class="list_bg"  width="40%">操作</th>
			</tr>
...
?>
			<tr <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['t']['index']%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
				...
				<td><?php echo $_smarty_tpl->tpl_vars['apppub']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['outsideip'];?>
</td>
