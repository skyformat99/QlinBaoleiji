<?php /* Smarty version 3.1.27, created on 2017-06-26 12:14:36
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/template/admin/sourceip.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:146049048459508a2c900353_59837668%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af25f604a990f22613a838fc8a9cddd64c6019b1' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/template/admin/sourceip.tpl',
      1 => 1474793220,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '146049048459508a2c900353_59837668',
  'variables' => 
  array (
    'title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_59508a2c9a7569_44168856',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_59508a2c9a7569_44168856')) {
function content_59508a2c9a7569_44168856 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '146049048459508a2c900353_59837668';
?>
	...
	<form name="ip_list" action="admin.php?controller=admin_pro&action=sourceip_delete" method="post">
                <TBODY>
                  <TR>
                    ...
                    <th class="list_bg" width="5%"><a href="admin.php?controller=admin_pro&action=sourceip&orderby1=groupname&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >选</a></TD>
                    <th class="list_bg"  width="20%"><a href="admin.php?controller=admin_pro&action=sourceip&orderby1=groupname&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >组名</a></TD>
                    <th class="list_bg"  width="20%"><a href="admin.php?controller=admin_pro&action=sourceip&orderby1=ipv6&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >类型</a></TD>
                    <th class="list_bg"  width="30%"><a href="admin.php?controller=admin_pro&action=sourceip&orderby1=groupname&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >描述</a></TD>
...
?>
			<tr  <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['t']['index']%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
				...
				<td width="5%"><input type="checkbox" name="chk_gid[]" value="<?php echo $_smarty_tpl->tpl_vars['s']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['groupname'];?>
"></td>
				 <td> <?php echo $_smarty_tpl->tpl_vars['s']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['groupname'];?>
</td>
				  <td> <?php if ($_smarty_tpl->tpl_vars['s']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['ipv6']) {?>IPv6<?php } else { ?>IPv4<?php }?></td>
				  <td> <?php echo $_smarty_tpl->tpl_vars['s']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['description'];?>
</td>
				<td style="TEXT-ALIGN: left;"><img src='<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/list_ico15.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="admin.php?controller=admin_pro&action=sourceip_list&groupname=<?php echo $_smarty_tpl->tpl_vars['s']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['groupname'];?>
" >IP</a>
				| <img src='<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/edit_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="admin.php?controller=admin_pro&action=sourceip_edit&groupname=<?php echo $_smarty_tpl->tpl_vars['s']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['groupname'];?>
