<?php /* Smarty version 3.1.27, created on 2017-05-22 19:41:51
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/template/admin/addforbiddengroup_command.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:11362050975922ce7f059296_33434558%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '050aaab0576892ab22cfd1c650f540f64314e587' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/template/admin/addforbiddengroup_command.tpl',
      1 => 1483270772,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11362050975922ce7f059296_33434558',
  'variables' => 
  array (
    'title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5922ce7f151537_43303999',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5922ce7f151537_43303999')) {
function content_5922ce7f151537_43303999 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '11362050975922ce7f059296_33434558';
?>
...
" <?php if ($_smarty_tpl->tpl_vars['regex']->value) {?>checked<?php }?> onclick="changeRegex(this.checked,0)" value="on">正则
	...
	<tr <?php if ($_smarty_tpl->tpl_vars['trnumber']->value++%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
		...
		<td width="67%">				
			<select  class="wbk"  name="level" onchange="sshouquan(this.value,0)">
	...
	<?php }?>
	<tr <?php if ($_smarty_tpl->tpl_vars['trnumber']->value++%2 == 0) {?>bgcolor="f7f7f7"<?php }?> id="shouquan">
		<td width="33%" align=right>
		授权:
		</td>
		<td width="67%">				
			<select  class="wbk"  name="toauthorize" id="toauthorize_0">
...
"  onchange="sshouquan(this.value,<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['c']['index'];?>
)">
			<option value="1" <?php if ($_smarty_tpl->tpl_vars['cmdinfo']->value['level'] == '1') {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['language']->value['Disconnect'];?>
</option>
			<option value="0" <?php if ($_smarty_tpl->tpl_vars['cmdinfo']->value['level'] == '0') {?>selected<?php }?>>命令阻断</option>
...
" id="toauthorize_<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['c']['index'];?>
">
			<option value="0" <?php if ($_smarty_tpl->tpl_vars['cmdinfo']->value['toauthorize'] == '0') {?>selected<?php }?>>不授权</option>
			<option value="1" <?php if ($_smarty_tpl->tpl_vars['cmdinfo']->value['toauthorize'] == '1') {?>selected<?php }?>>Admin授权</option>
			<option value="2" <?php if ($_smarty_tpl->tpl_vars['cmdinfo']->value['toauthorize'] == '2') {?>selected<?php }?>>分组管理员授权</option>
...
<?php echo '<script'; ?>
 language="javascript">
function sshouquan(v,i){
	if(v==3){
		document.getElementById('toauthorize_'+i).disabled=false;
	}else{
		document.getElementById('toauthorize_'+i).disabled=true;
	}
}
<?php if ($_smarty_tpl->tpl_vars['cmdinfo']->value) {?>
sshouquan(<?php echo $_smarty_tpl->tpl_vars['cmdinfo']->value['level'];?>
,0);
<?php }?>
