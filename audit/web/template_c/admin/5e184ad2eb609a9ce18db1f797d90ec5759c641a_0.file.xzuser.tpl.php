<?php /* Smarty version 3.1.27, created on 2017-10-10 13:40:29
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/template/admin/xzuser.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:210552754159dc5d4d2c93f0_17785944%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5e184ad2eb609a9ce18db1f797d90ec5759c641a' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/template/admin/xzuser.tpl',
      1 => 1492351472,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '210552754159dc5d4d2c93f0_17785944',
  'variables' => 
  array (
    'template_root' => 0,
    'allsgroup' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_59dc5d4d360169_63779038',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_59dc5d4d360169_63779038')) {
function content_59dc5d4d360169_63779038 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '210552754159dc5d4d2c93f0_17785944';
?>
...
function filter(){
	...
	useroptions.options.length=0;
	for(var i=0; i<AllMember.length; i++){
		if(/*window.opener.AllMember[i]['groupid']==selectedgroup &&*/ AllMember[i]['username'].indexOf(username3)>=0 || AllMember[i]['realname'].indexOf(username3)>=0){
			useroptions.options[useroptions.options.length] = new Option(AllMember[i]['username']+'('+AllMember[i]['realname']+')', 'user_'+AllMember[i]['uid']);
			if(window.opener.document.getElementById('uid_'+AllMember[i]['uid'])!=null&&window.opener.document.getElementById('uid_'+AllMember[i]['uid'])!=undefined&&window.opener.document.getElementById('uid_'+AllMember[i]['uid']).checked){
				useroptions.options[useroptions.options.length-1].style.color="red";
			}
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
              <tr>
                <td width="75%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" class=BBtable>
                  <tr>
                    <td>
                      <INPUT name="username2" id="username2" type="text" style="width:80px;display: none;"> 
                        &nbsp;&nbsp;用户查找
