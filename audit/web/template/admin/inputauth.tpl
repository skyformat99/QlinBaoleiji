           ...
           <form name="f1" method=post enctype="multipart/form-data" action="admin.php?controller=admin_pro&action=doinputauth" target="hide">
            ...
            cellpadding="5" valign="top">
              ...
              <TR>
                ...
                <TD><INPUT name="password" id="password" type="password" value="{{$password}}" autocomplete="off">{{if $showusers }}&nbsp;&nbsp;<INPUT type="checkbox" {{if $saveedpwdit}}checked{{/if}} value="1" name="saveedpwdit">保存{{/if}}&nbsp;&nbsp;</TD></TR>
              <TR>
