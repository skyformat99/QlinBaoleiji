  ...
  <tr>
	...
	<tr bgcolor="f7f7f7">
	  ...
	  <td width="33%" align=center>
		...
		<option value="{{$resource[ra].devicesid}}_1" title="{{$resource[ra].username}}_{{$resource[ra].uname}}_{{$resource[ra].lmname}}_{{$resource[ra].device_ip}}">{{$resource[ra].username}}_{{$resource[ra].uname}}_{{$resource[ra].lmname}}_{{$resource[ra].device_ip}}_{{$resource[ra].hostname}}</option>
		{{/section}}
		{{*
		{{section name=rr loop=$res}}
		<option value="{{$res[rr].devicesid}}_1" title="{{$res[rr].username}}_{{$res[rr].uname}}_{{$res[rr].lmname}}_{{$res[rr].device_ip}}" move="no">{{$res[rr].username}}_{{$res[rr].lmname}}_{{$res[rr].device_ip}}_{{$res[rr].hostname}}</option>
		{{/section}}
		*}}
		</select>
		</td>
		...
		<option value="{{$res[r].devicesid}}_1" title="{{$res[r].username}}_{{$res[r].uname}}_{{$res[r].lmname}}_{{$res[r].device_ip}}" selected>{{$res[r].username}}_{{$res[r].lmname}}_{{$res[r].device_ip}}_{{$res[r].hostname}}</option>
		{{/section}}
   		</select>
	  </td>
	</tr>
