...
{{/if}}
      ...
      <TD bordercolor="white"><input type="text" id="sshport" name="sshport" value="{{$member.sshport}}" >
      </TD></tr><tr>
      <TD align="right" bordercolor="white">RDP登录端口：</TD>
      <TD bordercolor="white"><input type="text" id="rdpport" name="rdpport" value="{{$member.rdpport}}" >
      </TD>
    </TR>
    				{{/if}}
    				<tr>
					...
					<option value="0" {{if $member.toolhostname eq 0}}selected{{/if}}>IP</option>
					<option value="1" {{if $member.toolhostname eq 1}}selected{{/if}}>主机名</option>
					</select>
