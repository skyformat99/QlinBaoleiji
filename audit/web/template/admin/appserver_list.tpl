...
<ul>
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
			<tr>
				...
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_config&action=appserver_list&orderby1=outsideip&orderby2={{$orderby2}}" >外网NAT IP</a></th>
