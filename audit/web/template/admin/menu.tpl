...
<div class="dtree" >
	<script type="text/javascript">
		...
		//dapp.s(1);
			...
			{{if $admin_level != 10 and $admin_level != 101 and $admin_level != 4 and $admin_level != 11}}
              <tr>
			  ...
			  {{/if}}
			 {{if $admin_level != 10  and $admin_level != 4 and $admin_level != 0 and $admin_level != 21 and $admin_level != 101 and $admin_level != 11}}
              <tr >
			   ...
			   <tr >
                <td align="left" valign="top" id="report" style="display:none" ><table width="100%"  border="0" cellpadding="0" cellspacing="2">
					...
					<tr>
                      <td height="25" align="left" bgcolor="52A1D4" class="zcd01"><img src="{{$template_root}}/images/tab_dot1.gif"   align="absmiddle"/> <a href="admin.php?controller=admin_reports&action=loginacct" target="main" onclick="return jumpto(this)">登录报表</a></td>
                    </tr>  
					<tr>
...
<div class="dtree" id="ddevtree">
	<script type="text/javascript">
		...
		ddev.s(0);
					...
					<tr>
                      <td height="25" align="left" bgcolor="52A1D4" class="zcd01"><img src="{{$template_root}}/images/tab_dot19.gif" width="18" height="21"  align="absmiddle"/> <a href="admin.php?controller=admin_config&action=appserver_list" target="main" onclick="return jumpto(this)">应用发布</a></td>
                    </tr>
					{{if $admin_level!=4}}
              ...
              <tr>
			   ...
			   <tr>
                <td align="left" valign="top"  id="other" style="display:none" ><table width="100%"  border="0" cellpadding="0" cellspacing="2">
					...
					{{if $amdin_level ==1 }}
					<tr>
                      <td height="25" align="left" bgcolor="52A1D4" class="zcd01"><img src="{{$template_root}}/images/list_ico4.gif" width="18" height="21"  align="absmiddle"/> <a href="admin.php?controller=admin_index&action=license" id="license" target="main" onclick="return jumpto(this)">License</a></td>
                    </tr>
					{{/if}}  
					{{if $amdin_level ==0 }}
					{{if $amdin_level ==1 }}
					...
					{{/if}}
					{{/if}} 
					{{if $admin_level !=10 && $admin_level !=2 and $admin_level != 11}}
					<tr>
...
{{elseif $smarty.get.actions eq 'license'}}
show_box('other');
